                        ...
                        renderItem={({ item, index }) => (
                            <><Card
                                    ...
                                    {item.ride.estado === "pendiente" && (
                                        <>
                                            <View style={{ width: 310 }}>
                                                <Text variant="titleLarge" style={[styles.textBorder, { borderBottomColor: "green", marginLeft: 20, marginTop: 10 }]}>OFERTAS</Text>
                                            </View>
                                            <View>
                                                <FlatList
                                                    data={item.ofertas}
                                                    renderItem={({ item, index }) => (
                                                        <><Card
                                                            key={index}
                                                            style={{ width: 295, borderRadius: 8, margin: 6, backgroundColor: "#D9D9D9", height: 65, marginLeft: 16 }} >
                                                            <Card.Content>
                                                                <View style={{ flexDirection: 'row' }}>
                                                                    <View style={{ flexDirection: 'row' }}>
                                                                    ...
                                                                    <View style={{ flexDirection: 'row', marginLeft: 90 }}>
                                                                        {/* <Ionicons name="cash" style={{ fontSize: 22, paddingTop: 6, marginRight: 6 }} /> */}
                                ...
                                <Card.Actions>
                                    ...
                                    <Button buttonColor={getInfoByStatus(item.ride.estado).color} textColor="white" style={{ width: 130 }}
                                        onPress={() => {
                                            setIndex(index);
                                            {
                                            ...
                                            getInfoByStatus(item.ride.estado).text : `${data[index].ride.calificacionC_P?.puntaje} `}
